...
function useChartGradient() {
  ...
  return React3.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime3.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime3.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime3.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse,
          scale,
          colorScale,
          colorMap,
...
function HighlightedProvider({
  ...
  const seriesById = React5.useMemo(() => {
  ...
  return (0, import_jsx_runtime4.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React6.useContext(HighlightedContext);
  if (!isInitialized) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React7.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React7.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var AnimationContext = React9.createContext({
  isInitialized: false,
  data: {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React10.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React11.createElement(Provider, { value: props }, children);
};
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React12.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime5.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React13.useContext(AnimationContext);
  if (!isInitialized) {
...
true ? ChartContainer.propTypes = {
  ...
  xAxis: import_prop_types2.default.arrayOf(import_prop_types2.default.shape({
    ...
    domainLimit: import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["nice", "strict"]), import_prop_types2.default.func]),
...
//# sourceMappingURL=chunk-LPEBGYQK.js.map

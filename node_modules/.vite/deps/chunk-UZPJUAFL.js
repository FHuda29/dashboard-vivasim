...
import {
  ...
  catmullRom_default,
  color,
  getColor_default3 as getColor_default,
  line_default,
  linear_default,
  monotoneX,
  monotoneY,
...
init_extends();
init_useId();
var _excluded12 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "experimentalMarkRendering"];
...
var LineChart = React14.forwardRef(function LineChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime13.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime13.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime13.jsxs)("g", _extends({}, clipPathGroupProps, {
    ...
    }), (0, import_jsx_runtime13.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime13.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime13.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime13.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   */
  experimentalMarkRendering: import_prop_types12.default.bool,
  /**
   ...
   */
  legend: import_prop_types12.default.shape({
   ...
   */
  margin: import_prop_types12.default.shape({
    bottom: import_prop_types12.default.number,
    left: import_prop_types12.default.number,
    right: import_prop_types12.default.number,
    top: import_prop_types12.default.number
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types12.default.bool,
  /**
   ...
   */
  tooltip: import_prop_types12.default.shape({
   ...
   */
  xAxis: import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
    classes: import_prop_types12.default.object,
    ...
    max: import_prop_types12.default.oneOfType([import_prop_types12.default.instanceOf(Date), import_prop_types12.default.number]),
    min: import_prop_types12.default.oneOfType([import_prop_types12.default.instanceOf(Date), import_prop_types12.default.number]),
    position: import_prop_types12.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types12.default.bool,
    scaleType: import_prop_types12.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types12.default.object,
    slots: import_prop_types12.default.object,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
    classes: import_prop_types12.default.object,
    colorMap: import_prop_types12.default.oneOfType([import_prop_types12.default.shape({
      colors: import_prop_types12.default.arrayOf(import_prop_types12.default.string).isRequired,
      type: import_prop_types12.default.oneOf(["ordinal"]).isRequired,
...
//# sourceMappingURL=chunk-UZPJUAFL.js.map

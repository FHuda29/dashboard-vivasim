    ...
    (() => {
      ...
      function w(e2) {
        var t2 = e2.o, n2 = t2.fs, o2 = n2.o, s2 = n2.x, c2 = t2.fss, a2 = function(e3, t3) {
          return function(e4) {
            ...
            if (null != n3) {
              ...
              try {
                if (i2 = (n3 = n3.call(e4)).next, 0 === t4) {
                  ...
                  a3 = false;
                } else for (; !(a3 = (o3 = i2.call(n3)).done) && (c3.push(o3.value), c3.length !== t4); a3 = true) ;
              } catch (e5) {
                l3 = true, r2 = e5;
              } finally {
                try {
                  if (!a3 && null != n3.return && (s3 = n3.return(), Object(s3) !== s3)) return;
                } finally {
                  if (l3) throw r2;
                }
              }
            ...
            if (e4) {
              if ("string" == typeof e4) return y(e4, t4);
      ...
      const A = function(e2) {
        var t2, n2, o2 = e2.fsLightbox, c2 = o2.componentsServices, a2 = o2.props.sources, l2 = o2.stageIndexes, u2 = (t2 = (0, r.useState)(l2.current + 1), n2 = 2, function(e3) {
          ...
          if (null != n3) {
            ...
            try {
              if (i2 = (n3 = n3.call(e3)).next, 0 === t3) {
                if (Object(n3) !== n3) return;
                a3 = false;
              } else for (; !(a3 = (o3 = i2.call(n3)).done) && (c3.push(o3.value), c3.length !== t3); a3 = true) ;
            } catch (e4) {
              l3 = true, r2 = e4;
            } finally {
              try {
                if (!a3 && null != n3.return && (s2 = n3.return(), Object(s2) !== s2)) return;
              } finally {
                if (l3) throw r2;
              }
            }
          ...
          if (e3) {
            if ("string" == typeof e3) return L(e3, t3);
      ...
      function F(e2) {
        var t2 = e2.o, n2 = t2.elements.sourcesComponents, o2 = t2.isl, s2 = t2.loc, c2 = t2.saw, a2 = t2.sawu, l2 = t2.st, u2 = t2.stageIndexes.current, f2 = e2.i, d2 = function(e3, t3) {
          return function(e4) {
            ...
            if (e4) {
              if ("string" == typeof e4) return z(e4, t4);
              var n3 = Object.prototype.toString.call(e4).slice(8, -1);
      ...
      const R = function(e2) {
        for (var t2 = e2.o, n2 = [], o2 = 0; o2 < t2.sl; o2++) n2.push(i().createElement(k, { o: t2, i: o2, key: o2 }));
        return i().createElement("div", { className: "".concat(d, " ").concat(l), onPointerDown: function(e3) {
          !function(e4, t3) {
            ...
            for (var c2 = 0; c2 < r2.length; c2++) r2[c2].d();
          }(t2, e3);
        } }, n2);
      };
      ...
      function M(e2) {
        for (var t2 = e2.props.sources, n2 = [], o2 = 0; o2 < t2.length; o2++) n2.push(i().createRef());
        return n2;
      }
      function U(e2, t2, n2) {
        for (var o2 = 0; o2 < e2.props.sources.length; o2++) e2.collections[t2][o2] = e2.resolve(n2, [o2]);
      }
      ...
      function te(e2, t2, n2) {
        ...
        this.getTypeSetByClientForIndex = function(e3) {
          ...
          !function(e4, t3) {
            ...
            n3.href = e4;
            var o3 = n3.hostname;
            if ("www.youtube.com" === o3 || "youtu.be" === o3) return t3(X);
      ...
      function ue(e2) {
        ...
        !function(e3) {
          ...
          n3.changeTo = function(n4) {
            ...
            n3.changeTo(e4);
            for (var h2 = 0; h2 < i2.length; h2++) i2[h2].d();
          ...
          s2.a = function() {
            for (var e4 in n3) r2[n3[e4]].s();
          }, s2.b = function(e4) {
            void 0 === e4 || i2.i(e4) || (r2[e4].h(), r2[e4].n());
          }, s2.c = function() {
            for (var e4 in n3) s2.d(n3[e4]);
          }, s2.d = function(e4) {
            if (t3[e4]) {
              var n4 = o3[e4];
          ...
          n3.runActions = function() {
            ...
            for (var e4 = 0; e4 < r2.length; e4++) i2[e4].d(), t3[e4] && r2[e4].current && t3[e4].adjustSize();
      ...
      function fe(e2, t2, n2, o2) {
        ...
        this.adjustSize = function() {
          if ((c2 = r2.maxSourceWidth / s2) < r2.maxSourceHeight) return n2 < r2.maxSourceWidth && (c2 = o2), a2();
      ...
      function be(e2, t2) {
        for (var n2 = 0; n2 < t2.length; n2++) {
          ...
          o2.enumerable = o2.enumerable || false, o2.configurable = true, "value" in o2 && (o2.writable = true), Object.defineProperty(e2, (void 0, r2 = function(e3, t3) {
            if ("object" !== he(e3) || null === e3) return e3;
            var n3 = e3[Symbol.toPrimitive];
            if (void 0 !== n3) {
              var o3 = n3.call(e3, "string");
              if ("object" !== he(o3)) return o3;
      ...
      var Ee = function(e2) {
        ...
        var t2, n2, o2, r2, a2 = (o2 = u2, r2 = we(), function() {
          ...
          } else e3 = t3.apply(this, arguments);
          return function(e4, t4) {
            if (t4 && ("object" === he(t4) || "function" == typeof t4)) return t4;
          ...
          return function(e4, t4) {
            ...
            e4.o = function() {
              ...
              e4.ii = true, function(e5) {
                ...
                f2(), function(e5) {
                  for (var t5 = e5.props.sources, n4 = e5.resolve, o4 = n4(W), r4 = n4(ee), i3 = n4(te, [o4, r4]), s3 = 0; s3 < t5.length; s3++) if ("string" == typeof t5[s3]) {
                    var c3 = i3.getTypeSetByClientForIndex(s3);
                    if (c3) r4.runActionsForSourceTypeAndIndex(c3, s3);
                    else {
                  ...
                  } else r4.runActionsForSourceTypeAndIndex(q, s3);
                }(e4), s2("onInit");
              });
            };
          }(ye(t3)), t3;
        ...
        return t2 = u2, n2 = [{ key: "timeout", value: function(e3, t3) {
          ...
          return n3.unshift(this), ge(e3, function(e4) {
            if (Array.isArray(e4)) return ve(e4);
          }(t3 = n3) || function(e4) {
            if ("undefined" != typeof Symbol && null != e4[Symbol.iterator] || null != e4["@@iterator"]) return Array.from(e4);
          }(t3) || function(e4, t4) {
            if (e4) {
              if ("string" == typeof e4) return ve(e4, t4);
          ...
          !function(e3) {
            for (var t3 = e3.collections.xhrs, n3 = e3.componentsServices.isLightboxOpenManager, o3 = e3.core.globalEventsController, r3 = 0; r3 < t3.length; r3++) t3[r3].abort();

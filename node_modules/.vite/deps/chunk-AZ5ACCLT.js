...
} from "./chunk-DOAX7SLP.js";
import {
  ChartContainer,
  ChartsContinuousGradient,
  useHighlighted
} from "./chunk-LPEBGYQK.js";
import {
  ZAxisContext,
  getValueToPositionMapper,
  useChartId
} from "./chunk-H5C3XLUA.js";
import {
  InteractionContext
} from "./chunk-NEHD4FY5.js";
import {
  useSvgRef
} from "./chunk-2QOKUIHO.js";
import {
  ChartsText,
  getStringSize,
  getWordsByLines
} from "./chunk-6WKD2UHK.js";
import {
  getLabel,
  getScale,
  isBandScale,
...
init_extends();
var _excluded = ["width", "height", "resolveSizeBeforeRender", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis", "skipAnimation"];
...
var ResponsiveChartContainer = React.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
function useMouseTracker() {
  ...
  const [mousePosition, setMousePosition] = React2.useState(null);
  React2.useEffect(() => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime2.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime2.jsx)("tbody", {
        children: (0, import_jsx_runtime2.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime2.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime2.jsx)(ChartsTooltipMark, {
              color,
              className: classes.mark
            })
          }), (0, import_jsx_runtime2.jsx)(ChartsTooltipCell, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types2.default.func.isRequired,
  /**
   ...
   */
  series: import_prop_types2.default.object.isRequired,
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React4.useContext(ZAxisContext);
  ...
  return (0, import_jsx_runtime3.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime4.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime4.jsx)("thead", {
        children: (0, import_jsx_runtime4.jsx)(ChartsTooltipRow, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime4.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime4.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime4.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
            }), (0, import_jsx_runtime4.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime4.jsx)(Typography_default, {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React6.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React6.useMemo(() => {
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime6.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime6.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime6.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime6.jsx)(ChartsAxisTooltipContent, {
...
function useAxisTooltip() {
  ...
  const {
    zAxis,
    zAxisIds
  } = React9.useContext(ZAxisContext);
  const colorProcessors = useColorProcessor();
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime7.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime7.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
var _excluded3 = ["rotate", "dominantBaseline"];
...
function LegendPerItem(props) {
  ...
  const labelStyle = React11.useMemo(
  ...
  const padding = React11.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React11.useCallback((label, inStyle = {}) => {
    const style = _objectWithoutPropertiesLoose(inStyle, _excluded3);
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React11.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React11.useMemo(() => {
  ...
  return (0, import_jsx_runtime8.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime8.jsx)(ChartsLegendRoot, {
...
var _excluded4 = ["drawingArea", "seriesToDisplay", "hidden", "onItemClick"];
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types5.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types5.default.shape({
  ...
  seriesToDisplay: import_prop_types5.default.arrayOf(import_prop_types5.default.shape({
    ...
    itemId: import_prop_types5.default.oneOfType([import_prop_types5.default.number, import_prop_types5.default.string]),
    label: import_prop_types5.default.string.isRequired,
    maxValue: import_prop_types5.default.oneOfType([import_prop_types5.default.instanceOf(Date), import_prop_types5.default.number]),
    minValue: import_prop_types5.default.oneOfType([import_prop_types5.default.instanceOf(Date), import_prop_types5.default.number]),
...
function ChartsLegend(inProps) {
  ...
  const {
    slots,
    slotProps
  } = defaultizedProps, other = _objectWithoutPropertiesLoose(defaultizedProps, _excluded5);
  const theme = useTheme();
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React14.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime11.jsxs)(React15.Fragment, {
    children: [(0, import_jsx_runtime11.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime11.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime11.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types7.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types7.default.oneOfType([import_prop_types7.default.number, import_prop_types7.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types7.default.oneOfType([import_prop_types7.default.func, import_prop_types7.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types7.default.oneOfType([import_prop_types7.default.func, import_prop_types7.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types7.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types7.default.number,
  /**
...
var _excluded6 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter", "onItemClick"];
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types8.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types8.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types8.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types8.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types8.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React17.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime13.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime13.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime13.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime13.jsx)(ChartsAxisHighlightPath, {
...
//# sourceMappingURL=chunk-AZ5ACCLT.js.map

...
} from "./chunk-6XU25OBZ.js";
import {
  _inheritsLoose,
  addClass,
  removeClass
} from "./chunk-47OXBP2P.js";
...
var EventRowMixin = {
  ...
  renderEvent: function renderEvent(props, event) {
    ...
    props.isAllDay;
    var accessors = props.accessors, getters = props.getters, onSelect = props.onSelect, onDoubleClick = props.onDoubleClick, onKeyPress = props.onKeyPress, localizer = props.localizer, slotMetrics2 = props.slotMetrics, components2 = props.components, resizable = props.resizable;
    var continuesPrior2 = slotMetrics2.continuesPrior(event);
    var continuesAfter2 = slotMetrics2.continuesAfter(event);
    return import_react25.default.createElement(EventCell, {
      event,
      getters,
      localizer,
      ...
      continuesPrior: continuesPrior2,
      continuesAfter: continuesAfter2,
      slotStart: slotMetrics2.first,
      slotEnd: slotMetrics2.last,
      selected: isSelected(event, selected),
      resizable
    });
  },
...
var EventEndingRow = function(_React$Component) {
  ...
  _createClass(EventEndingRow2, [{
    ...
    value: function renderShowMore(segments, slot) {
      var _this = this;
      var _this$props2 = this.props, localizer = _this$props2.localizer, slotMetrics2 = _this$props2.slotMetrics;
      var events = slotMetrics2.getEventsForSlot(slot);
...
function getSlotMetrics(_ref2) {
  ...
  return {
    ...
    nextSlot: function nextSlot(slot2) {
      ...
      if (next === slot2) next = localizer.add(slot2, step, "minutes");
      return next;
    },
...
var Event = function() {
  function Event2(data, _ref) {
    var accessors = _ref.accessors, slotMetrics2 = _ref.slotMetrics;
    _classCallCheck(this, Event2);
    var _slotMetrics$getRange = slotMetrics2.getRange(accessors.start(data), accessors.end(data)), start = _slotMetrics$getRange.start, startDate = _slotMetrics$getRange.startDate, end = _slotMetrics$getRange.end, endDate = _slotMetrics$getRange.endDate, top = _slotMetrics$getRange.top, height2 = _slotMetrics$getRange.height;
    this.start = start;
    this.end = end;
...
function getStyledEvents$1(_ref2) {
  var events = _ref2.events, minimumStartDifference = _ref2.minimumStartDifference, slotMetrics2 = _ref2.slotMetrics, accessors = _ref2.accessors;
  var proxies = events.map(function(event) {
    return new Event(event, {
      slotMetrics: slotMetrics2,
      accessors
    });
  });
...
function noOverlap(_ref) {
  var events = _ref.events, minimumStartDifference = _ref.minimumStartDifference, slotMetrics2 = _ref.slotMetrics, accessors = _ref.accessors;
...
var DayColumn = function(_React$Component) {
  ...
  function DayColumn2() {
    ...
    _this._selectable = function() {
      ...
      var selectionState = function selectionState2(point) {
        var currentSlot = slotMetrics.closestSlotFromPoint(point, getBoundsForNode(node));
  ...
  _createClass(DayColumn2, [{
    ...
    value: function getDerivedStateFromProps(nextProps) {
      slotMetrics = slotMetrics ? slotMetrics.update(nextProps) : getSlotMetrics(nextProps);
      return null;
    }
  }]);
  return DayColumn2;
...
var TimeGutter = function TimeGutter2(_ref2) {
  ...
  var _useState = (0, import_react25.useState)(getSlotMetrics({
    ...
    step,
    localizer
  })), _useState2 = _slicedToArray(_useState, 2), slotMetrics2 = _useState2[0], setSlotMetrics = _useState2[1];
  (0, import_react25.useEffect)(function() {
    if (slotMetrics2) {
      setSlotMetrics(slotMetrics2.update({
        min: start,
        max: end,
        timeslots,
        step,

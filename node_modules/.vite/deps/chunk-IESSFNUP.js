...
var PluginContext = React2.createContext({
  isInitialized: false,
  data: {
    colorProcessors: {},
    seriesFormatters: {},
...
function useColorProcessor(seriesType) {
  const {
    isInitialized,
    data
  } = React4.useContext(PluginContext);
  if (!isInitialized) {
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React11.useContext(SeriesContext);
  if (!isInitialized) {
...
var useChartDimensions = (width, height, margin) => {
  ...
  const drawingArea = React12.useMemo(() => ({
...
var DrawingContext = React13.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React13.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React13.useCallback(({
    x: x2,
    y: y2
  }, options) => {
  ...
  const value = React13.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React13.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
  return (0, import_jsx_runtime3.jsx)(SvgContext.Provider, {
    value: refValue,
    children: (0, import_jsx_runtime3.jsx)(DrawingContext.Provider, {
      value,
      children
    })
  });
...
function useDrawingArea() {
  const {
    ...
    right,
    isPointInside
  } = React14.useContext(DrawingContext);
...
function CartesianProvider(props) {
  ...
  const xValues = React17.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React17.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
//# sourceMappingURL=chunk-IESSFNUP.js.map

...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React12.useRef(false);
  const firstFocus = React12.useRef(true);
  const inputRef = React12.useRef(null);
  const listboxRef = React12.useRef(null);
  const [anchorEl, setAnchorEl] = React12.useState(null);
  const [focusedTag, setFocusedTag] = React12.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React12.useRef(defaultHighlighted);
  ...
  const resetInputValue = React12.useCallback((event, newValue, reason) => {
  ...
  const [inputPristine, setInputPristine] = React12.useState(true);
  ...
  const syncHighlightedIndex = React12.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React12.useRef(false);
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(React19.Fragment, {
...
var DropdownContext = React20.createContext(null);
if (true) {
...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React21.useRef(initialState);
  React21.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React21.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const controlledPropsRef = React21.useRef(controlledProps);
  if (true) {
    React21.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
  ...
  const reducerWithControlledState = React21.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    const newState = reducer(controlledState, action);
    return newState;
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React21.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React21.useCallback((action) => {
    dispatch({
      ...action,
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React22.useState("");
  const [triggerElement, setTriggerElement] = React22.useState(null);
  const lastActionType = React22.useRef(null);
  const handleStateChange = React22.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React22.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime6.jsxs)(React24.Fragment, {
    children: [(0, import_jsx_runtime6.jsx)("div", {
      tabIndex: open ? 0 : -1,
      onFocus: handleFocusSentinel,
      ref: sentinelStart,
      "data-testid": "sentinelStart"
    }), React24.cloneElement(children, {
      ref: handleRef,
      onFocus
...
var FormControl = React26.forwardRef(function FormControl2(props, forwardedRef) {
  const {
    defaultValue,
    children,
    disabled = false,
  ...
  React26.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = {
    ...props,
    disabled,
    error,
  ...
  const childContext = React26.useMemo(() => {
    return {
      disabled,
      error,
      filled,
...
function useFormControlContext() {
  return React27.useContext(FormControlContext);
}
...
function useList(params) {
  ...
  const actionContext = React31.useMemo(() => ({
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = React36.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React36.useRef(open);
  const {
    subitems,
...
var Portal = React39.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  if (disablePortal) {
    if (React39.isValidElement(children)) {
      ...
      return React39.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime10.jsx)(React39.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime10.jsx)(React39.Fragment, {
...
var TransitionContext = React40.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React41.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React42.useState(true);
  const hasPendingExitTransition = React42.useRef(false);
  const registeredTransitions = React42.useRef(0);
  const [hasTransition, setHasTransition] = React42.useState(false);
  const previousRequestEnter = React42.useRef(requestEnter);
  React42.useEffect(() => {
  ...
  const handleExited = React42.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React42.useCallback(() => {
...
var PopupContext = React43.createContext(null);
if (true) {
...
var Popup = React44.forwardRef(function Popup2(props, forwardedRef) {
  const {
    anchor: anchorProp,
    children,
    container,
  ...
  const popupContextValue = React44.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React45.forwardRef(function Menu2(props, forwardedRef) {
  const {
    actions,
    anchor: anchorProp,
    children,
  ...
  React45.useImperativeHandle(actions, () => ({
    dispatch,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React46.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React47.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    label,
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React48.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React50.memo(React50.forwardRef(function MenuItem(props, forwardedRef) {
  const {
    children,
    disabled: disabledProp = false,
    label,
...
var MenuItem2 = React50.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const modal = React51.useRef({});
  const mountNodeRef = React51.useRef(null);
  const modalRef = React51.useRef(null);
  const handleRef = useForkRef(modalRef, rootRef);
  const [exited, setExited] = React51.useState(!open);
  ...
  const isTopModal = React51.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Modal = React52.forwardRef(function Modal2(props, forwardedRef) {
  const {
    children,
    closeAfterTransition = false,
    container,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(React53.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React54.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React54.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React54.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React55.forwardRef(function NumberInput2(props, forwardedRef) {
  const {
    className,
    defaultValue,
    disabled,
...
var OptionGroup = React56.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {},
...
function useOption(params) {
  ...
  const selectOption = React57.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React58.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React58.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React58.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
var InnerOption = React59.memo(React59.forwardRef(function Option(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
...
var Option2 = React59.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var PopperTooltip = React60.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React60.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React60.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React60.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React60.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React60.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React60.useState(resolveAnchorEl(anchorEl));
  React60.useEffect(() => {
...
var Popper = React60.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function useSelect(props) {
  ...
  const optionValues = React61.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React61.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React61.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    return (option == null ? void 0 : option.disabled) ?? false;
  }, [getOptionByValue]);
  const stringifyOption = React61.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React61.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React61.useCallback((itemValue) => {
    var _a;
    return (_a = options.get(itemValue)) == null ? void 0 : _a.id;
  }, [options]);
  const handleSelectionChange = React61.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React61.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue ?? null);
  }, [onHighlightChange]);
  const handleStateChange = React61.useCallback((event, field, fieldValue) => {
    var _a;
    if (field === "open") {
  ...
  const getItemDomElement = React61.useCallback((itemId) => {
    var _a;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React61.useRef(open);
  useEnhancedEffect_default(() => {
    var _a;
  ...
  const getOptionMetadata = React61.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime22.jsx)(React63.Fragment, {
...
var Select = React63.forwardRef(function Select2(props, forwardedRef) {
  const {
    areOptionsEqual,
    autoComplete,
    autoFocus,
  ...
  const [buttonDefined, setButtonDefined] = React63.useState(false);
  ...
  const handleButtonRefChange = React63.useCallback((element) => {
  ...
  return (0, import_jsx_runtime22.jsxs)(React63.Fragment, {
...
function useSlider(parameters) {
  ...
  const touchId = React64.useRef(void 0);
  const [active, setActive] = React64.useState(-1);
  const [open, setOpen] = React64.useState(-1);
  const [dragging, setDragging] = React64.useState(false);
  const moveCount = React64.useRef(0);
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React64.useState(-1);
  ...
  const previousIndex = React64.useRef(void 0);
  ...
  const stopListening = React64.useCallback(() => {
    const doc = ownerDocument(sliderRef.current);
...
var Slider = React65.forwardRef(function Slider2(props, forwardedRef) {
  const {
    "aria-label": ariaLabel,
  ...
  return (0, import_jsx_runtime23.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime23.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime23.jsxs)(React65.Fragment, {
      ...
      const style = axisProps2[axis].offset(percent);
      const resolvedSlotProps = resolveComponentProps2(slotProps.thumb, ownerState, {
        index: index2,
...
var Snackbar = React67.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React69.forwardRef(function Switch2(props, forwardedRef) {
  const {
    checked: checkedProp,
    defaultChecked,
    disabled: disabledProp,
...
var TablePaginationActions = React70.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  const {
    count,
...
var TablePagination = React71.forwardRef(function TablePagination2(props, forwardedRef) {
  const {
    colSpan: colSpanProp,
    count,
...
function useTabs(parameters) {
  ...
  const onSelected = React72.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React72.useRef(() => void 0);
  const getTabPanelId = React72.useCallback((tabValue) => {
    var _a;
    return (_a = tabPanels.get(tabValue)) == null ? void 0 : _a.id;
  }, [tabPanels]);
  const getTabId = React72.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React72.useCallback((lookupFunction) => {
...
var TabsContext = React73.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React73.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React75.forwardRef(function Tabs2(props, forwardedRef) {
  const {
    children,
    value: valueProp,
    defaultValue,
...
function useTabPanel(parameters) {
  ...
  const metadata = React76.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React77.forwardRef(function TabPanel2(props, forwardedRef) {
  const {
    children,
    value,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React78.useCallback((tabValue) => {
    var _a;
    return (_a = subitems.get(tabValue)) == null ? void 0 : _a.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React78.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React78.useCallback((tabValue) => {
    var _a;
    if (tabValue == null) {
      return null;
    }
  ...
  const handleChange = React78.useCallback((event, newValue) => {
    onSelected(event, newValue[0] ?? null);
  }, [onSelected]);
  const controlledProps = React78.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React78.useCallback((item) => {
    var _a;
...
var TabsList = React80.forwardRef(function TabsList2(props, forwardedRef) {
  const {
    children,
    slotProps = {},
    slots = {},
...
function useTab(parameters) {
  ...
  const tabMetadata = React81.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React82.forwardRef(function Tab2(props, forwardedRef) {
  const {
    action,
    children,
    disabled = false,
...
var TextareaAutosize = React83.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const {
    current: isControlled
  } = React83.useRef(value != null);
  const inputRef = React83.useRef(null);
  const handleRef = useForkRef(forwardedRef, inputRef);
  const heightRef = React83.useRef(null);
  const shadowRef = React83.useRef(null);
  const calculateTextareaStyles = React83.useCallback(() => {
  ...
  const syncHeight = React83.useCallback(() => {
  ...
  return (0, import_jsx_runtime34.jsxs)(React83.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React84.useRef(true);
  React84.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React84.useCallback((event) => {
...
var CssTransition = React85.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React85.useState(false);
  React85.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React85.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2LEVACLI.js.map

...
} from "./chunk-HETUZNZD.js";
import {
  hasPlugin,
  useTreeViewLabel,
  warnOnce
} from "./chunk-ZRGBPV7T.js";
import {
  TreeViewCollapseIcon,
  TreeViewExpandIcon
} from "./chunk-MWIYCWNW.js";
import {
  TreeItem2Provider
...
var TreeItem = React3.forwardRef(function TreeItem2(inProps, inRef) {
  var _a, _b, _c, _d;
  const {
    icons: contextIcons,
    runItemPlugins,
  ...
  const expansionIcon = expandable && !!ExpansionIcon ? (0, import_jsx_runtime3.jsx)(ExpansionIcon, _extends({}, expansionIconProps)) : null;
  ...
  const displayIcon = DisplayIcon ? (0, import_jsx_runtime3.jsx)(DisplayIcon, _extends({}, displayIconProps)) : null;
  ...
  const icon = Icon ? (0, import_jsx_runtime3.jsx)(Icon, _extends({}, iconProps)) : null;
  let ariaSelected;
  if (selected) {
    ariaSelected = true;
  ...
  return (0, import_jsx_runtime3.jsx)(TreeItem2Provider, {
    itemId,
    children: (0, import_jsx_runtime3.jsxs)(TreeItemRoot, _extends({
...
//# sourceMappingURL=chunk-6NPLZRBG.js.map

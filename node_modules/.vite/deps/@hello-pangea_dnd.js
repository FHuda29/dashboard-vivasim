...
function useUniqueId(prefix3, options = defaults) {
  ...
  return useMemo(() => `${prefix3}${options.separator}${id}`, [options.separator, prefix3, id]);
}
...
function PrivateDraggable(props) {
  ...
  return import_react2.default.createElement(ConnectedDraggable, props);
}
...
var Droppable = (props) => {
  ...
  const placeholder2 = useMemo(() => import_react2.default.createElement(AnimateInOut, {
    ...
    data,
    animate
  }) => import_react2.default.createElement(Placeholder$1, {
    placeholder: data,
    onClose,

...
var u = (0, import_react.forwardRef)(function(o2, u2) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    return { continuousStart: function(t2, e2) {
      if (void 0 === e2 && (e2 = 1e3), !Q.active) if (H) console.warn("react-top-loading-bar: You can't use both controlling by props and ref methods to control the bar!");
      else {
        var o3 = t2 || s(10, 20);
    ...
    if (u2) {
      if (u2 && void 0 !== d) return void console.warn(`react-top-loading-bar: You can't use both controlling by props and ref methods to control the bar! Please use only props or only ref methods! Ref methods will override props if "ref" property is available.`);
      at(B), J(false);
    } else d && at(d), J(true);
  }, [d]);

...
var Drawer = React.forwardRef(function Drawer2(inProps, ref) {
  ...
  const drawer = (0, import_jsx_runtime.jsx)(DrawerPaper, {
  ...
  if (variant === "permanent") {
    return (0, import_jsx_runtime.jsx)(DrawerDockedRoot, {
  ...
  const slidingDrawer = (0, import_jsx_runtime.jsx)(TransitionComponent, {
    in: open,
  ...
  return (0, import_jsx_runtime.jsx)(DrawerRoot, {
    BackdropProps: {
      ...BackdropProps,
      ...BackdropPropsProp,
      transitionDuration
...
//# sourceMappingURL=chunk-JDJFBST7.js.map

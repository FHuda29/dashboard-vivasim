...
function Scatter(props) {
  ...
  return (0, import_jsx_runtime.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types.default.func,
  markerSize: import_prop_types.default.number.isRequired,
  /**
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(React2.Fragment, {
    children: seriesOrder.map((seriesId) => {
      ...
      const colorGetter = getColor_default(series[seriesId], xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId], yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId], zAxis[zAxisId ?? zAxisKey ?? defaultZAxisId]);
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime2.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color,
        colorGetter,
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React3.useRef({});
  const delauneyRef = React3.useRef(void 0);
  const lastFind = React3.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
...
true ? ChartsVoronoiHandler.propTypes = {
   ...
   */
  voronoiMaxRadius: import_prop_types3.default.number
} : void 0;

// node_modules/@mui/x-charts/ScatterChart/useScatterChartProps.js
init_extends();
var _excluded = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React4.forwardRef(function ScatterChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime4.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime4.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime4.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime4.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime4.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime4.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime4.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime4.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime4.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime4.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default false
   */
  disableVoronoi: import_prop_types4.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types4.default.shape({
    horizontal: import_prop_types4.default.bool,
    vertical: import_prop_types4.default.bool
  }),
  /**
...
//# sourceMappingURL=chunk-XTWKSXIF.js.map

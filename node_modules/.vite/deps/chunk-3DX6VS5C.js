...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React10.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React10.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React10.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React10.useState(noSsr || !isMultiSchemes);
  React10.useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  const Grid2 = React13.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime10.jsx)(GridRoot, {
      ...
      children: React13.Children.map(children, (child) => {
        var _a;
        if (React13.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3DX6VS5C.js.map

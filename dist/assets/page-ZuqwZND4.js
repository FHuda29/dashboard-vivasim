...
`);function ft(){const[e,a]=O.useState(null),[i,r]=O.useState(void 0),o=(l,n,s)=>{r(s.id),a(n)};return t.jsx(w,{title:"OnSeriesItemClick Chart",codeModel:t.jsx(bt,{}),children:t.jsxs(ee,{direction:{xs:"column",md:"row"},alignItems:{xs:"flex-start",md:"center"},justifyContent:"space-between",sx:{width:"100%"},children:[t.jsx(ce,{component:"pre",sx:{maxWidth:{xs:"100%",md:"50%",flexShrink:1},overflow:"auto"},children:`item id: ${i??"undefined"}
                   ...
                   item identifier:
                   ${xt(e)}`}),t.jsx(S,{series:[{data:At}],onItemClick:o,width:400,height:200,margin:{right:200}})]})})}const Rt=[{to:"/",title:"Home"},{title:"PieCharts "}],ga=()=>t.jsxs(se,{title:"PieCharts",description:"this is PieCharts ",children:[t.jsx(ne,{title:"PieCharts",items:Rt}),t.jsxs(G,{container:!0,spacing:3,children:[t.jsx(G,{size:{md:6},children:t.jsx(Ke,{})}),t.jsx(G,{size:{md:6},children:t.jsx(qe,{})}),t.jsx(G,{size:{md:6},children:t.jsx(Ze,{})}),t.jsx(G,{size:{md:6},children:t.jsx(it,{})}),t.jsx(G,{size:{md:6},children:t.jsx(st,{})}),t.jsx(G,{size:{md:6},children:t.jsx(Ct,{})}),t.jsx(G,{size:{md:6},children:t.jsx(ct,{})}),t.jsx(G,{size:{md:6},children:t.jsx(ft,{})})]})]});export{ga as default};

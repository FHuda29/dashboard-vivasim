...
const CreateTopup = () => {
        ...
        axios
            ...
            .then(async (response) => {
                ...
                */
                ...
                const str_ccid = formData[`ccid_1`];
                //add order
                const dataOrder = {
                    seq: 0,
                    order_id: order_id,
  ...
  */
  ...
  return (
    <PageContainer title="Topup Simcard" description="this is topup Simcard">
        <Breadcrumb title="Topup Simcard" items={BCrumb} />
        <BlankCard>
          <CardContent>
